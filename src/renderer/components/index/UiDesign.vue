<template>
  <div class="RecVideo">
    <h3 class="comIndexTitle"><strong>UI设计</strong><span>共<i>{{numFontVideo}}</i>节课</span><a href="javascript:;">更多</a></h3>
    <div class="fontUicen">
      <div class="fontUiMore">
        <a href="javascript:;">UI设计</a>
        <a href="javascript:;">查看更多</a>
      </div>
      <div class="swiper-container swiperSlide7">
    ...
    methods: {
      recSlide: function () {
        ...
        _this.$nextTick(function () {
          _this.mySwiper = new Swiper('.swiperSlide7', {
            loop: true,
            slidesPerView: 'auto',
            spaceBetween: 30,
