<template>
  <div class="RecVideo">
    <h3 class="comIndexTitle"><strong>推荐视频</strong><span>共<i>{{numRecVideo}}</i>节课</span><a href="javascript:;">更多</a></h3>
    <div class="swiper-container swiperSlide2">
    ...
    created () {
      ...
      axios.get('/static/json/recVideo.json')
        .then(function (response) {
          ...
          _this.numRecVideo = response.data.videoSlide.length
          _this.recSlide()
    ...
    methods: {
      recSlide: function () {
        ...
        _this.$nextTick(function () {
          _this.mySwiper = new Swiper('.swiperSlide2', {
            loop: true,
            slidesPerView: 'auto',
            spaceBetween: 30,
